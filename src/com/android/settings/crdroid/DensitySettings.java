...
public class DensitySettings extends SettingsPreferenceFragment {
    ...
    private static void setDensity(int density) {
        ...
        killRunningApps(/*defaultKeyboard*/);
    }
                ...
                case DIALOG_CUSTOM_DENSITY:
                    ...
                    setDefault.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            dpi.setProgress(Integer.parseInt(
                                    getCrDroidDefaultDensity()) - mMinDensity);
                            setTextDPI(newDPI, getCrDroidDefaultDensity());
                        }
                    });
    ...
    public static String getCrDroidDefaultDensity() {
        String defaultDensity = null;
        try {
            ...
            while ((strLine = br.readLine()) != null) {
                ...
                if (line[0].equalsIgnoreCase(DENSITY_PROP)) {
                    defaultDensity = line[1];
                }
            }
            in.close();
        } catch (Exception e) {
